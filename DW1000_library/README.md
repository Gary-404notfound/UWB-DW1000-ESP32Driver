...
Add configuration check to solve network id config fail.
...
- see more library and example:[jremington/UWB-Indoor-Localization_Arduino: Open source Indoor localization using Arduino and ESP32_UWB tags + anchors](https://github.com/jremington/UWB-Indoor-Localization_Arduino)
